...
For each assigned reading, you will submit a short ($\sim 2$ paragraphs) report.

Quizzes will be held during class or lab unannounced.  We will drop your
two lowest scores.
...
\textbf{Laptop} use during class is recommend, but it is expected that you will be
...
\textbf{Class discussion}:  We will be using Piazza for class discussion.
Rather than emailing questions to the teaching staff, you should post
your questions on Piazza.

To help your fellow students, the GSI, and me in responding to your questions,
you should review Eric Raymond's How To Ask Questions The Smart
Way (\url{http://www.catb.org/esr/faqs/smart-questions.html}).

Find our class page at: \url{https://piazza.com/berkeley/fall2015/statistics159/home}\\

\textbf{Students with disabilities}: If you need accommodations for any physical,
...
Homework 2 \dotfill Oct. 29\\
Progress report \dotfill Nov. 3 \& 5\\
Homework 3 \dotfill Nov. 19\\
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Scientific computing with Python I
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Scientific computing with Python II
...
\begin{itemize} \itemsep-0.4em
	...
	\item \textbf{Reading 4}: KJ Millman and F P\'{e}rez.
...
\begin{itemize} \itemsep-0.4em
	...
	\item \textbf{Reading 5}: V Stodden.
...
\begin{itemize} \itemsep-0.4em
	...
	\item \textbf{Reading 6}: DA Freedman.
              ``Statistics and the scientific method.'' (1985)
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
        \vspace{1mm}
        \item \textbf{Project progress report}
        \vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	...
	\item \textbf{Reading 7}: JB Buckheit and DL Donoho.
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Model selection / validation ?
	\item \textbf{Homework 3}: fMRI related?
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Final thoughts/Selective inference, Thanksgiving
	\item \textbf{Reading 8 (Extra credit)}: JW Tukey. ``The future of data analysis.''
