...
by 17:00 on the Thursday it is due.
...
There will be 2 homeworks (to be submitted by 17:00 on the Thursday it is
...
office hours so that I can make the necessary arrangements.\\
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
        \item Model selection/validation, Selective inference
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
...
\begin{itemize} \itemsep-0.4em
	\vspace{1mm}
	\item Final thoughts, Thanksgiving
	\vspace{1mm}
\end{itemize}
\end{minipage} \\
\hline
